 ...
 * extents: it joins the multi-process group of a running HOMI daemon and asks
 * HOMI to resolve a file's extents (homic_get_extents). These tests therefore
 ...
 * HOMI), and runs the backend-agnostic test logic.
 */
